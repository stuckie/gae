...
TARGETS	 = builddir glesgae.a bin/windowtest bin/filestest bin/buttontest bin/nineslicetest

.PHONY: all
all: $(TARGETS)

.PHONY: tests
tests: bin/windowtest bin/filestest bin/buttontest bin/nineslicetest
